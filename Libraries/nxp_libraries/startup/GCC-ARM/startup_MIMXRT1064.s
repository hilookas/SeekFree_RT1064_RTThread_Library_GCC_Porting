...
@ #ifdef FLEXRAM_CF_ENABLE
    .equ _iomux_gpr14_adr, 0x400AC038
    .equ _iomux_gpr16_adr, 0x400AC040
    .equ _iomux_gpr17_adr, 0x400AC044
    .equ _flexram_bank_cfg, 0xAAAAAAAF
    .equ _flexram_itcm_size, 0x7 @ 64KB
    .equ _flexram_dtcm_size, 0xA @ 448KB

    ldr r0, =_iomux_gpr17_adr
    ldr r1, =_flexram_bank_cfg
    str r1, [r0]
